...
describe("revokedStatusOnContracts", () => {
  ...
  it("should return empty array if no smart contract is provided", async () => {
    const revokedStatus = await revokedStatusOnContracts([], INTERMEDIATE_HASHES);
    expect(revokedStatus).toEqual([]);
  });
...
describe("getIntermediateHashes", () => {
  it("returns array with single hash if no proof is present", () => {
    const targetHash = "f7432b3219b2aa4122e289f44901830fa32f224ee9dfce28565677f1d279b2c7";
    const expected = ["0xf7432b3219b2aa4122e289f44901830fa32f224ee9dfce28565677f1d279b2c7"];
...
describe("verifyRevoked", () => {
  it("returns valid summary of the status if document is not revoked on any smart contracts", async () => {
    ...
    // @ts-ignore
    expect(isRevoked.mock.calls).toEqual([
      [{ address: "0x0A", type: v3.Method.DocumentStore, instance: contract }, "0x0d"],
      [
        { address: "0x0A", type: v3.Method.DocumentStore, instance: contract },
        "0x96851128a70d034965e58c4ef4681d4ffcf60ba27322aa9015cf340f2b242e3d"
      ],
      [{ address: "0x0B", type: v3.Method.DocumentStore, instance: contract }, "0x0d"],
      [
        { address: "0x0B", type: v3.Method.DocumentStore, instance: contract },
        "0x96851128a70d034965e58c4ef4681d4ffcf60ba27322aa9015cf340f2b242e3d"
      ]
