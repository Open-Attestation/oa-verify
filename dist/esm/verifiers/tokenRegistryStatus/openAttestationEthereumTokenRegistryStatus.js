...
export var openAttestationEthereumTokenRegistryStatus = {
    ...
    test: function (document) {
        if (utils.isWrappedV3Document(document)) {
            ...
            return documentData_1.proof.method === v3.Method.TokenRegistry;
        }
    ...
    verify: function (document, options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    tokenRegistries = getIssuersTokenRegistry(document);
                    ...
                    return [4 /*yield*/, Promise.all(tokenRegistries.map(function (tokenRegistry) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 3, , 4]);
                                        return [4 /*yield*/, TradeTrustErc721Factory.connect(tokenRegistry, getProvider(options))];
                                    case 1:
                                        tokenRegistryContract = _a.sent();
                                        return [4 /*yield*/, tokenRegistryContract
                                                .ownerOf(merkleRoot_1)
                                                .then(function (owner) { return !(owner === constants.AddressZero); })];
                                    case 2:
                                        minted = _a.sent();
                                        status = {
                                            minted: minted,
                                        ...
                                        if (!minted) {
                                            status.reason = contractNotMinted(merkleRoot_1, tokenRegistry);
                                        }
                                        return [2 /*return*/, status];
                                    case 3:
                                        e_2 = _a.sent();
                                        return [2 /*return*/, { minted: false, address: tokenRegistry, reason: getErrorReason(e_2, tokenRegistry, merkleRoot_1) }];
