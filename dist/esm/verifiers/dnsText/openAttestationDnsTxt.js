...
import { getData, v2, v3, utils as oaUtils } from "@govtechsg/open-attestation";
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                return [4 /*yield*/, getDefaultProvider(options.network).getNetwork()];
            case 1:
                network = _e.sent();
...
export var openAttestationDnsTxt = {
    skip: function () {
    ...
    verify: function (document, options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    if (!oaUtils.isWrappedV2Document(document)) return [3 /*break*/, 2];
