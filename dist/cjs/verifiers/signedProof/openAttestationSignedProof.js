...
exports.openAttestationSignedProof = void 0;
...
exports.openAttestationSignedProof = {
    skip: function () {
        return Promise.resolve({
            ...
            name: name,
            reason: {
                code: error_1.OpenAttestationDocumentSignedCode.SKIPPED,
                codeString: error_1.OpenAttestationDocumentSignedCode[error_1.OpenAttestationDocumentSignedCode.SKIPPED],
                message: "Document does not have a proof block",
            },
        });
    },
    test: function (document) {
        return open_attestation_1.utils.isSignedWrappedV2Document(document);
    },
        ...
        return __generator(this, function (_a) {
            try {
                ...
                if (proofValid) {
                    ...
                    reason = {
                        code: error_1.OpenAttestationDocumentSignedCode.DOCUMENT_PROOF_INVALID,
                        codeString: error_1.OpenAttestationDocumentSignedCode[error_1.OpenAttestationDocumentSignedCode.DOCUMENT_PROOF_INVALID],
                        message: message,
                    };
                ...
                status = "ERROR";
                reason = {
                    code: error_1.OpenAttestationDocumentSignedCode.DOCUMENT_PROOF_ERROR,
                    codeString: error_1.OpenAttestationDocumentSignedCode[error_1.OpenAttestationDocumentSignedCode.DOCUMENT_PROOF_ERROR],
                    message: message,
                };
