...
exports.openAttestationEthereumDocumentStoreStatus = exports.isAnyHashRevoked = void 0;
...
exports.isAnyHashRevoked = function (smartContract, intermediateHashes) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.openAttestationEthereumDocumentStoreStatus = {
    ...
    test: function (document) {
        if (open_attestation_1.utils.isWrappedV3Document(document)) {
            ...
            return documentData_1.proof.method === open_attestation_1.v3.Method.DocumentStore;
        }
    ...
    verify: function (document, options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    documentStores = utils_1.getIssuersDocumentStore(document);
                    ...
                    return [4 /*yield*/, Promise.all(documentStores.map(function (documentStore) { return __awaiter(void 0, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 3, , 4]);
                                        return [4 /*yield*/, document_store_1.DocumentStoreFactory.connect(documentStore, utils_1.getProvider(options))];
                                    case 1:
                ...
                case 1:
                    ...
                    if (notIssued) {
                        return [2 /*return*/, {
                                ...
                                data: {
                                    issuedOnAll: false,
                                    details: open_attestation_1.utils.isWrappedV3Document(document)
                ...
                case 3:
                    ...
                    return [2 /*return*/, {
                            ...
                            reason: {
                                message: e_1.message,
                                code: error_1.OpenAttestationEthereumDocumentStoreStatusCode.UNEXPECTED_ERROR,
                                codeString: error_1.OpenAttestationEthereumDocumentStoreStatusCode[error_1.OpenAttestationEthereumDocumentStoreStatusCode.UNEXPECTED_ERROR],
                            },
                            status: "ERROR",
                        }];
                case 4: return [2 /*return*/];
