...
export const tokenRopstenInvalid: SignedDocument = {
  ...
  data: {
    ...
    $template: {
      name:
        "873fd4e8-1d9f-401d-92c6-6c40db495491:string:CERTIFICATE_OF_NON_MANIPULATION",
      type: "8f6f8119-f85d-4f8f-9696-4c3a942e0b07:string:EMBEDDED_RENDERER",
      url:
        "a3c7a619-491e-4a0b-8bb7-eef3277d9b28:string:https://demo-cnm.openattestation.com"
    },
    issuers: [
      {
        name: "31e6be0b-7190-4560-84ff-2155d36b9f54:string:DEMO STORE",
        tokenRegistry:
          "9610d97f-e52a-43c6-986c-35293655e489:string:0x48399Fb88bcD031C556F53e93F690EEC07963Af3",
        identityProof: {
    ...
    consignment: {
      description:
        "2ea2e970-4a73-4e74-ae9d-b6f459a33849:string:16667 CARTONS OF RED WINE",
      quantity: {
      ...
      outwardBillNo:
        "47616244-898f-419c-9b03-96f585411cb1:string:AQSIQ170923130",
      ...
      countryOfFinalDestination:
        "1346832a-45f4-467c-ac0d-ff7b6fd60848:string:CHINA",
      outgoingVehicleNo:
        "1a771225-8f5b-4a49-91bd-800d4beedfec:string:COSCO JAPAN 074E/30-JAN"
    },
    declaration: {
      name: "9f0f0431-c9d9-45bf-9562-0daa9fc2068a:string:PETER LEE",
      designation:
        "e9ea18f2-a050-4c25-99de-c4a7a0d18eda:string:SHIPPING MANAGER",
  ...
  signature: {
    ...
    targetHash:
      "1e63c39cdd668da652484fd781f8c0812caadad0f6ebf71bf68bf3670242d1ef",
    proof: [],
    merkleRoot:
      "1e63c39cdd668da652484fd781f8c0812caadad0f6ebf71bf68bf3670242d1ef"
  }
