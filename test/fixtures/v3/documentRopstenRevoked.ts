...
export const documentRopstenRevoked: WrappedDocument<v3.OpenAttestationDocument> = {
  ...
  data: {
    ...
    template: {
      ...
      url:
        "7f902de4-791d-4f61-9c30-47ba19e784e5:string:http://localhost:3000/rederer"
    },
    validFrom:
      "acfc42ee-6578-41f8-8dc9-3836192273db:string:2018-08-30T00:00:00+08:00",
    proof: {
      type:
        "c7d88250-c3d5-434a-994f-8063a0668340:string:OpenAttestationSignature2018",
      method: "57cfc114-38e2-43a1-b176-b59484125e6c:string:DOCUMENT_STORE",
      value:
        "c0315415-ff65-4223-97e5-dadd1bd72a04:string:0x8Fc57204c35fb9317D91285eF52D6b892EC08cD3"
    },
    issuer: {
  ...
  signature: {
    ...
    targetHash:
      "ba106f273697b46862f5842fc805902fa65d1f41d50953e0aeb815e43e989fc1",
    proof: [],
    merkleRoot:
      "ba106f273697b46862f5842fc805902fa65d1f41d50953e0aeb815e43e989fc1"
  }
