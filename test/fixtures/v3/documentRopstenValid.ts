...
export const documentRopstenValidWithDocumentStore: WrappedDocument<v3.OpenAttestationDocument> = {
  ...
  data: {
    ...
    template: {
      ...
      url:
        "cabe4859-a1e6-4394-a88f-4a3bb30e05ae:string:http://localhost:3000/rederer"
    },
    validFrom:
      "b72d0f94-e7a0-47b8-bbb2-91bc7397c406:string:2018-08-30T00:00:00+08:00",
    proof: {
      type:
        "0a9e819c-1e18-4c6e-bd2b-0d34e97e3d27:string:OpenAttestationSignature2018",
      method: "006b1ad2-c284-4373-9742-b83ab97bf173:string:DOCUMENT_STORE",
      value:
        "434d9cf9-5ce1-4ac0-a960-4badd935834c:string:0x8Fc57204c35fb9317D91285eF52D6b892EC08cD3"
    },
    issuer: {
  ...
  signature: {
    ...
    targetHash:
      "7f42e288dfdb20e7f9a62329adf1f3ad8eed0345a2c517ee7af3e9e88d02a5cd",
    proof: [],
    merkleRoot:
      "7f42e288dfdb20e7f9a62329adf1f3ad8eed0345a2c517ee7af3e9e88d02a5cd"
  }
...
export const documentRopstenValidWithTokenRegistry: WrappedDocument<v3.OpenAttestationDocument> = {
  ...
  data: {
    ...
    template: {
      ...
      url:
        "88702cff-ce27-44e7-bf8e-6cb45ddb7918:string:http://localhost:3000/rederer"
    },
    validFrom:
      "1d232808-479d-4483-9160-dc492023efc4:string:2018-08-30T00:00:00+08:00",
    proof: {
      type:
        "79960528-60d9-47c2-86cf-f7600d6c6d68:string:OpenAttestationSignature2018",
      method: "705020cb-8037-46c4-aa21-f9c2705704a2:string:TOKEN_REGISTRY",
      value:
        "8b970c38-4768-4f60-8034-ad946fd80e1d:string:0xb53499ee758352fAdDfCed863d9ac35C809E2F20"
    },
    issuer: {
  ...
  signature: {
    type: "SHA3MerkleProof",
    targetHash:
      "cd42f7aee8bc73cd82d9aeb5de71ebb4cfa663235e342204e269acb7517e69fc",
    proof: [],
    merkleRoot:
      "cd42f7aee8bc73cd82d9aeb5de71ebb4cfa663235e342204e269acb7517e69fc"
  }
