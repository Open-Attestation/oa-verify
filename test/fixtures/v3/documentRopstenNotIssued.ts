...
export const documentRopstenNotIssued: WrappedDocument<v3.OpenAttestationDocument> = {
  ...
  data: {
    ...
    template: {
      ...
      url:
        "f0b0332b-b6db-4bd0-8ea8-14bd079d61c8:string:http://localhost:3000/rederer"
    },
    validFrom:
      "5a7063dd-f8be-45df-931d-75080bd5c701:string:2018-08-30T00:00:00+08:00",
    proof: {
      type:
        "ba78d365-b039-46fa-a843-b96005a9b49c:string:OpenAttestationSignature2018",
      method: "f0bb4f79-c8a3-476b-8e51-d947d0406047:string:DOCUMENT_STORE",
      value:
        "0b9bbe75-8421-4e70-a176-cba76843216d:string:0x8Fc57204c35fb9317D91285eF52D6b892EC08cD3"
    },
    issuer: {
  ...
  signature: {
    ...
    targetHash:
      "76cb959f49db0cffc05107af4a3ecef14092fd445d9acb0c2e7e27908d262142",
    proof: [],
    merkleRoot:
      "76cb959f49db0cffc05107af4a3ecef14092fd445d9acb0c2e7e27908d262142"
  }
