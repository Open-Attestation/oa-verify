...
export const documentRopstenValidWithIssuerDID: WrappedDocument<v3.OpenAttestationDocument> = {
  ...
  data: {
    ...
    issuer: {
      ...
      identityProof: {
        // Update identity proof to use W3C-DID type
        type: "1c5ce8f4-7fcc-4285-9d33-5d3c38c53ad1:string:W3C-DID",
        location:
          "79009458-fdd6-42fe-a3b9-d13ac8d4ca91:string:did:ethr:ropsten:0xB26B4941941C51a4885E5B7D3A1B861E54405f90"
      }
    }
  },
  privacy: {
