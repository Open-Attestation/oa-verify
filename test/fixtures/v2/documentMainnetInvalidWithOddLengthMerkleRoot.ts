...
export const documentMainnetInvalidWithOddLengthMerkleRoot: WrappedDocument<CustomDocument> = {
  version: SchemaId.v2,
  ...
  signature: {
    ...
    proof: [],
    // merkleRoot's last character has been removed to make it odd-length (63 char)
    merkleRoot: "61dc9186345e05cc2ae53dc72af880a3b66e2fa7983feaa6254d1518540de50",
  },
};
