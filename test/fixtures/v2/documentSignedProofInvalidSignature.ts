import { ProofPurpose, ProofType, SchemaId, SignedWrappedDocument, v2 } from "@govtechsg/open-attestation";

/**
 * The proof.signature has been tampered with changing the first 3 characters to 000
 */
export const documentSignedProofInvalidSignature: SignedWrappedDocument<v2.OpenAttestationDocument> = {
  version: SchemaId.v2,
  data: {
  ...
  proof: {
    ...
    // The signature has been tampered with changing the first 3 characters to 000
    signature:
      "0x000619768d669c58f4fd491eea10f20149467c3a996f06887cd27ee6915d39d069c66bcf719213c3d470c9a3dc94c11808248e9650ac80c578d1514a59d4409a1b",
  },
};
